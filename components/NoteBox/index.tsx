...
const NoteBox: React.FC<NoteBoxProps> = (props) => {
    return (
        <div className={`grid grid-flow-row auto-rows-max overflow-y-auto justify-center ${props.bgcolor} mx-5 my-8 rounded-3xl w-72 max-h-screen`}>
            ...
            {props.contents.map(content => (
                <div className={`${props.color} flex flex-row my-2 py-2 rounded-3xl h-12 w-64 place-content-between items-center`}>
                    ...
                    <div className='flex flex-row justify-items-center mx-2'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="black" className="w-4 h-4 mx-0.5">
