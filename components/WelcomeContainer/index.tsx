...
const WelcomeContainer: React.FC<WelcomeContainer> = (props) => {
    ...
    return (
        <div className='flex flex-row xl:m-2 sm:mx-1 sm:w-11/12 px-2 py-2 bg-secondary xl:h-1/3 sm:h-48 xl:w-3/5 items-center self-center bg-thirdWELCOME rounded-3xl relative'>
            <div className='flex flex-col xl:w-5/6 sm:w-3/4'>
                <div className="flex flex-col xl:w-3/5 sm:w-3/4 sm:text-4xl  xl:text-5xl font-bold my-2 absolute left-5 top-5">
